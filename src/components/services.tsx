          ...
          {services.map((service, index) => (
            <Dialog key={index}>
              <DialogTrigger asChild>
                <Card className="text-center bg-background border-border hover:border-primary hover:shadow-lg transition-all transform hover:-translate-y-2 cursor-pointer">
